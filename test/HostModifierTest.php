...
class HostManipulatorTest extends TestCase
{
    ...
    public function testPrependLabelProcess($label, $key, $prepend, $append, $replace)
    {
        ...
        $this->assertSame($prepend, $modifier->process($this->uri)->getHost());
    }
    ...
    public function testAppendLabelProcess($label, $key, $prepend, $append, $replace)
    {
        ...
        $this->assertSame($append, $modifier->process($this->uri)->getHost());
    }
    ...
    public function testReplaceLabelProcess($label, $key, $prepend, $append, $replace)
    {
        ...
        $this->assertSame($replace, $modifier->process($this->uri)->getHost());
    }
    ...
    public function testHostToUnicodeProcess()
    {
        ...
        $this->assertSame($expected, (string) $modifier->process($uri));
    ...
    public function testWithoutLabelsProcess($keys, $expected)
    {
        ...
        $this->assertSame($expected, $modifier->process($this->uri)->getHost());
    }
    ...
    public function testRemoveLabels()
    {
        ...
        $this->assertSame('example.com', (string) $modifier->process($this->uri)->getHost());
    }
    ...
    public function testSubdomain()
    {
        ...
        $this->assertSame('shop.example.com', (string) $modifier->process($this->uri)->getHost());
    }

    public function testRegisterableDomain()
    {
        $modifier = new RegisterableDomain('ulb.ac.be');
        $this->assertSame('www.ulb.ac.be', (string) $modifier->process($this->uri)->getHost());
    }

    public function testAddRootLabel()
    {
        $modifier = new AddRootLabel();
        $this->assertSame('www.example.com.', (string) $modifier->process($this->uri)->getHost());
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        (new HostToUnicode())->process('http://www.example.com');
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        (new HostToAscii())->process('http://www.example.com');
    }

    public function testWithoutZoneIdentifierProcessFailed()
    {
        $this->expectException(InvalidArgumentException::class);
        (new RemoveZoneIdentifier())->process('http://www.example.com');
    }

    public function testAppendLabelProcessFailed()
    {
        $this->expectException(InvalidArgumentException::class);
        (new AppendLabel(''))->process('http://www.example.com');
    }

    public function testPrependLabelProcessFailed()
    {
        $this->expectException(InvalidArgumentException::class);
        (new PrependLabel(''))->process('http://www.example.com');
    }
}
