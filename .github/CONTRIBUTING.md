...
We accept bug reports via issues created on [Github](https://github.com/thephpleague/uri-manipulations/issues).
...
- **Always try the [master branch](https://github.com/thephpleague/uri-manipulations)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/thephpleague/uri-manipulations/pull).
